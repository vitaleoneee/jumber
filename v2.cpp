...
void instructions(){
  ...
  cout<<"1. lumberjack"<<endl<<"2. Back to main menu"<<endl;
  cin>> instruction;
...
void developer(){
  ...
  clear();
  cout<<"Developer contacts: "<<endl<<"Telegram: @vitaleoneee"<<endl<<"Instagram: vitaleoneee"<<endl<<"Gmail: gubenko23r@gmail.com"<<endl<<"Support the developer with a coin: 5168 7451 3184 3655"<<endl;
